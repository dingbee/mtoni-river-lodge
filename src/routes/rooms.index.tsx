...
function Meta({icon,label}:{icon:React.ReactNode;label:string}) { return <div className="min-w-0"><div className="flex items-center gap-1.5 text-primary">{icon}</div><p className="mt-1 truncate text-xs text-muted-foreground">{label}</p></div>; }
