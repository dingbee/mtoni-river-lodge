      ...
      <section className="px-6 pb-24 lg:px-12 lg:pb-32">
        <div className="mx-auto grid max-w-[1200px] gap-16 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <h2 className="font-display text-4xl leading-tight lg:text-5xl">Where the river meets earth and stillness.</h2>
          </div>
  ...
  head: () => ({
    ...
    scripts: [
      ...
      buildBreadcrumbJsonLd([
        ...
        { name: RIVERFRONT_DELUXE_ROOM.name, path: "/rooms/riverfront-deluxe" },
      ]),
    ],
  }),
