      ...
      <main>
        ...
        <section className="border-y bg-muted/20 px-6 py-12 lg:px-10 lg:py-16">
          <div className="mx-auto max-w-7xl">
            ...
            <Link to="/book" search={{ room: "riverfront-deluxe" }} className="mt-7 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground">
