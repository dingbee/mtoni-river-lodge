...
export const Route = createFileRoute("/check-in/expired")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "This online check-in link has expired. Contact reception for a new link." },
      { property: "og:title", content: "Check-In Link Expired — Mtoni River Lodge" },
      { property: "og:description", content: "This online check-in link has expired. Contact reception for a new link." },
