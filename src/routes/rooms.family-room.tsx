  ...
  return (
    <div className="bg-ivory text-charcoal">
      ...
      <PageHero
        ...
        cta={{ label: "Check Availability", bookingRoomSlug: "family-room" }}
      />
      ...
      <section className="px-6 pb-24 lg:px-12 lg:pb-32">
        <div className="mx-auto grid max-w-[1200px] gap-16 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <h2 className="font-display text-4xl leading-tight lg:text-5xl">Space to gather, room to breathe.</h2>
          </div>
        ...
        <div className="mx-auto max-w-[900px] text-center">
          <Reveal>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                href={buildRoomInquiryUrl(FAMILY_ROOM.name)}
                target="_blank"
