...
export const Route = createFileRoute("/check-in/success")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your online check-in details have been received by Mtoni River Lodge." },
      { property: "og:title", content: "Check-In Received — Mtoni River Lodge" },
      { property: "og:description", content: "Your online check-in details have been received by Mtoni River Lodge." },
