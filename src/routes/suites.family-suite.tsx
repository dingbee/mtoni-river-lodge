...
import { FAMILY_SUITE, SUITES, getSuitePath } from "@/lib/suites";

function FamilySuitePage() {
  const suite = FAMILY_SUITE;
...
export const Route = createFileRoute("/suites/family-suite")({
  head: () => ({
    meta: [
      { title: `${FAMILY_SUITE.name} — Mtoni River Lodge` },
      { name: "description", content: FAMILY_SUITE.shortDesc },
      { property: "og:title", content: `${FAMILY_SUITE.name} — Mtoni River Lodge` },
      { property: "og:description", content: FAMILY_SUITE.shortDesc },
      { property: "og:image", content: FAMILY_SUITE.img },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: FAMILY_SUITE.img },
    ],
  }),
