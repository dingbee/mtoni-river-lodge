...
const TABS = [
  ...
  { to: "/admin/restaurant/pricing", label: "Pricing", icon: Tags },
  { to: "/admin/restaurant/products", label: "Products & Recipes", icon: CookingPot },
  ...
  { to: "/admin/restaurant/procurement", label: "Procurement", icon: ClipboardCheck },
