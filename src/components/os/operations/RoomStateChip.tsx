...
const STYLES: Record<RoomStateValue, { label: string; className: string }> = {
  vacant_clean:   { label: "Vacant clean",   className: "bg-emerald-500/15 text-[color:var(--os-success)] border-emerald-500/30" },
  vacant_dirty:   { label: "Vacant dirty",   className: "bg-amber-500/15 text-[color:var(--os-warn)] border-amber-500/30" },
  ...
  out_of_service: { label: "Out of service", className: "bg-rose-500/15 text-[color:var(--os-danger)] border-rose-500/30" },
};
